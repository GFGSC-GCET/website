        ...
        <div className='container grid grid-cols-1 gap-5 mx-auto px-6 mt-5 xl:mt-0 xl:gap-5 lg:grid-cols-5 h-fit'>
          <div className="col-span-1 w-full h-42">
             <div class="z-20 w-full rounded-md ">
                <a href="#" class="flex items-center px-3 py-3 text-lg text-green-500 capitalize transition-colors duration-300 transform dark:text-gray-300 bg-green-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
...
{/* 
                <a href="#" class="flex items-center p-3 text-lg text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                    <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
