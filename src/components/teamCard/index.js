...
const TeamCard = (props) => {
    return (
        <div
            class=" px-8 pt-6 pb-2 duration-300 transform border cursor-pointer rounded-xl group dark:border-gray-700">
            ...
            <p class="my-4 text-gray-500 capitalize line-clamp-2 dark:text-gray-300">
